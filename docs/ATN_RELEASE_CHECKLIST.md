...
Dernière release GitHub publique : **1.7.8**. La **version source 1.7.9** est candidate ; la release GitHub publique : **1.7.9** jusqu’aux gates Thunderbird 156 et à la publication. La soumission Add-ons for Thunderbird reste une étape distincte.
