# Publication de MailPerch 1.4.0
...
La version 1.4.0 conserve le fonctionnement local et les permissions de 1.3.0, ajoute la portée par comptes Thunderbird sélectionnés, fiabilise Options/Dashboard/panneau et ajoute un banc fonctionnel réel jusqu’à 2 000 épingles. Les contrôles automatisés du dépôt couvrent la syntaxe, les ressources, les permissions, la CSP, l’absence de réseau, les contrats API, les migrations, les compteurs natifs, l’accessibilité, les modèles JavaScript/SQLite, le scan de secrets et le packaging.
...
- `dist/MailPerch_v1.4.0.xpi` — extension à téléverser ;
- `dist/MailPerch_GitHub_Repository_v1.4.0.zip` — sources complètes pour review ;
