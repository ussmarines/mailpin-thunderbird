...
check(fr_locale.get("extensionName", {}).get("message") == "MailPin — Email Follow-up & Productivity for Thunderbird", "nom FR MailPin incohérent")
check(en_locale.get("extensionName", {}).get("message") == "MailPin — Email Follow-up & Productivity for Thunderbird", "nom EN MailPin incohérent")
