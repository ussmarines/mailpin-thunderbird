...
Le build 1.1.2 est conçu pour l’environnement reviewer standard et a besoin uniquement de :
...
```text
dist/MailPerch_v1.1.2.xpi
dist/MailPerch_GitHub_Repository_v1.1.2.zip
dist/SHA256SUMS.txt
```
