...
Le build 1.2.0 est conçu pour l’environnement reviewer standard et a besoin uniquement de :
...
```text
dist/MailPerch_v1.2.0.xpi
dist/MailPerch_GitHub_Repository_v1.2.0.zip
dist/SHA256SUMS.txt
```
