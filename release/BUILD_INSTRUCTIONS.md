...
Le build 1.1.1 est conçu pour l’environnement reviewer standard et a besoin uniquement de :
...
```text
dist/MailPerch_v1.1.1.xpi
dist/MailPerch_GitHub_Repository_v1.1.1.zip
dist/SHA256SUMS.txt
```
