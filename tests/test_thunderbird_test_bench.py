...
# manual dispatch remains available for explicit reruns. Thunderbird 156.0 is
# the release-candidate runtime gate for MailPin 1.7.9.
assert "workflow_dispatch:" in WORKFLOW
assert re.search(r"branches:\s*\n\s*- main", WORKFLOW)
assert "pull_request:" in WORKFLOW
assert 'THUNDERBIRD_VERSION: "156.0"' in WORKFLOW
