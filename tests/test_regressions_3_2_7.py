...
assert '.thread-card-icon-info .button-star' in CSS
assert 'inset-block-start: 50%;' in CSS
...
# Critical controls bind before visual enhancement, use capture delegation,
# validate numbers, and read back persisted state before success.
...
assert 'document.addEventListener("click", event =>' in OPTIONS
