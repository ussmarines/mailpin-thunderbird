...
> **État : build de développement 3.1.4.** Les contrôles statiques, les tests de modèle et les gardes de régression sont exécutés automatiquement. Une validation graphique complète dans Thunderbird reste obligatoire avant publication.
...
3. Sélectionner `dist/MailPerch_v3.1.4.xpi`.
