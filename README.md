...
1. Téléchargez `MailPerch_v1.1.1.xpi` depuis la release `v1.1.1`.
...
> Les anciennes builds internes `3.2.x` utilisaient un numéro supérieur aux versions publiques actuelles. Pour tester `1.1.1` après une build de développement, utilisez un profil de test propre ou désinstallez d’abord l’ancienne build après avoir exporté vos données MailPerch.
...
- [Audit de sécurité 1.1.1](SECURITY_AUDIT_1.1.1.md)
- [Rapport de validation 1.1.1](VALIDATION_REPORT_1.1.1.md)
