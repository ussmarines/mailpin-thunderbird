...
> **État : build de développement 3.2.9.** Les contrôles statiques, les tests de modèle et les gardes de régression sont exécutés automatiquement. Une validation graphique complète dans Thunderbird reste obligatoire avant publication.
...
3. Sélectionner `dist/MailPerch_v3.2.9.xpi`.
